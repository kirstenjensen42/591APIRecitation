...
/*
 * Enum to collect all the information needed from a Tweet
 */
public class TwitterProperty {
	...
	public TwitterProperty(String fromSN, long fromID, String text, Date sentDate, GeoLocation location, String name, long tweetID, Status stat) {
		this.fromSN = fromSN;
		this.fromID = fromID;
		this.text = text;
